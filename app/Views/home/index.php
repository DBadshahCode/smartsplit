...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px;margin-bottom:28px;">
    ...
    <div class="ss-card" style="padding:20px 22px;">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;">
            ...
            <div
                style="width:36px;height:36px;border-radius:10px;background:#fef9c3;display:flex;align-items:center;justify-content:center;">
...
<div id="dashboard-grid" style="display:grid;grid-template-columns:1fr 300px;gap:20px;align-items:start;">
    ...
    <div style="display:flex;flex-direction:column;gap:16px;">
        ...
        <!-- This month card -->
        <div class="ss-card"
            style="padding:20px 22px;background:linear-gradient(135deg,#1a1b4b 0%,#2e3191 100%);border:none;">
