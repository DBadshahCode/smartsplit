...
<div style="display:flex;flex-wrap:wrap;gap:10px;margin-bottom:24px;">
    ...
    <div
        style="display:flex;align-items:center;gap:8px;padding:8px 14px;background:#fff;border:1px solid #e2e8f0;border-radius:8px;">
...
">
    ...
    <form id="addExpenseTypeForm" style="padding:20px 24px 24px;">
        ...
        <div style="margin-bottom:16px;">
            ...
            <div style="position:relative;">
                <i data-lucide="align-left"
                    style="position:absolute;left:13px;top:13px;width:15px;height:15px;color:#94a3b8;pointer-events:none;"></i>
                <textarea id="et-desc" name="description" placeholder="Brief description of this expense category…"
                    rows="2" class="ss-input" style="padding-left:38px;resize:vertical;min-height:44px;"
                    onfocus="this.style.borderColor='#7f94f7';this.style.boxShadow='0 0 0 3px rgba(127,148,247,.15)'"
        ...
        <div style="margin-bottom:16px;">
            ...
            <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;" id="split-selector">
                ...
                " onclick="selectSplit('equal')">
                    <div
                        style="width:28px;height:28px;border-radius:8px;background:#e0e7ff;display:flex;align-items:center;justify-content:center;">
                ...
                " onclick="selectSplit('daysPresent')">
                    <div
                        style="width:28px;height:28px;border-radius:8px;background:#fef9c3;display:flex;align-items:center;justify-content:center;">
                ...
                " onclick="selectSplit('custom')">
                    <div
                        style="width:28px;height:28px;border-radius:8px;background:#f1f5f9;display:flex;align-items:center;justify-content:center;">
        ...
        <div style="margin-bottom:24px;">
            ...
            <div
                style="display:flex;align-items:center;gap:12px;padding:12px 14px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;">
