...
<div class="ss-card" style="margin-bottom:24px;">
    <div class="ss-card-body" style="padding:20px 24px;">
        <div style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:16px;">
            ...
            <!-- View button -->
            <button onclick="loadDistribution(document.getElementById('month-input').value)" class="ss-btn ss-btn-ghost"
...
<div id="summary-cards" style="display:none;margin-bottom:24px;">
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:14px;">
        ...
        <div class="ss-card" style="padding:16px 18px;">
            ...
            <div id="sum-due"
                style="font-size:22px;font-weight:700;color:#dc2626;letter-spacing:-0.02em;font-family:'JetBrains Mono',monospace;">
                —</div>
...
<div class="ss-card" id="distribution-card">
    <div class="ss-card-header"
        ...
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;">
            ...
            <?php if (session()->get('role') === 'admin'): ?>
                <button id="btnExportExcel" onclick="exportExcel()" style="display:none;align-items:center;gap:7px;
                ...
                <tr>
                    <td colspan="6" style="padding:56px 16px;text-align:center;color:#cbd5e1;">
                        <div style="display:flex;flex-direction:column;align-items:center;gap:10px;">
                            ...
                            <span style="font-size:13px;color:#cbd5e1;">Select a month and click
                                <?= session()->get('role') === 'admin' ? 'Generate to calculate' : 'View to load' ?> the
                                distribution</span>
                        </div>
                    </td>
                </tr>
...
<script>
    ...
    <tr>
        ...
        $.get('/finaldistribution/getDistribution/' + month, function (res) {
            ...
            // Show/hide export button in card header
    ...
    // Re-render Lucide for the new icon
